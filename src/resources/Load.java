...
public class Load {
    ...
    public static Game getRecommendation(){
        ...
        return new Game(new String[]{"Shooter"}, 004,"Half-Life", new String[]{"Singleplayer"}, 86,
    ...
    public static GameQueue getGameQueue(){
        ...
        queue.add(new Game(new String[]{"Action"}, 000,"E.T. the Extra-Terrestrial", new String[]{"BAD"}, 06,
        ...
        queue.add(new Game( new String[]{"Casual"}, 001,"Animal Crossing: New Horizons", new String[]{"Fun"}, 93,
                "https://animal-crossing.com/new-horizons/assets/img/share-fb.jpg", "2020", new String[]{"Switch"}, 789));
        queue.add(new Game(new String[]{"RPG"}, 003,"BioShock", new String[]{"FPS"}, 80,
